...
namespace BuySell.WebUI.Models
{
    public class BikeAdViewModel
    {
        ...
        [Required(ErrorMessage = "Color of this Bike.")]
        [Display(Name = "Color")]
        ...
        //Lists for DropDowns
        public virtual IEnumerable<VehicleBrand> VehicleBrandsList { get; set; }
        public virtual IEnumerable<Year> YearsList { get; set; }
        public virtual IEnumerable<Color> ColorsList { get; set; }
