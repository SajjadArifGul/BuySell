namespace BuySell.DAL.Migrations
{
    ...
    public partial class ReviewsModelAdded : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Ads", t => t.AdID, cascadeDelete: false)
                .Index(t => t.AdID);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccessoryBrands", t => t.AccessoryBrandID, cascadeDelete: false)
                .ForeignKey("dbo.Ads", t => t.AdID, cascadeDelete: false)
